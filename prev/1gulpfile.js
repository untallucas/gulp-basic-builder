...
gulp.task('main:markup', function () {
  return gulp
    .src(paths.src.markup + '/*.{htm,html,php,json,md}')
...
gulp.task('build:static',
  ...
  gulp.parallel('build:images', 'build:fonts', 'build:plugins', 'build:docs', 'build:icons')
)
...
gulp.task('watch', function () {
  gulp.watch(paths.src.markup + '/**/*.{htm,html,php,json,md}', gulp.series('main:markup', 'reload'))
...
// DEFAULT
// gulp.task('default', gulp.series('main:clean', gulp.parallel('main:markup', 'main:styles', 'main:scripts', 'main:static', 'vendor:scripts', 'vendor:styles'), 'serve', 'watch'))
gulp.task('default', gulp.series('main:clean', gulp.parallel('main:markup', 'main:styles', 'main:scripts', 'main:static'), 'serve', 'watch'))

// BUILD
// gulp.task('build', gulp.series('build:clean', gulp.parallel('build:markup', 'build:styles', 'build:scripts', 'build:static', 'vendor:scripts', 'vendor:styles'), 'build:createfiles'))
gulp.task('build', gulp.series('build:clean', gulp.parallel('build:markup', 'build:styles', 'build:scripts', 'build:static'), 'build:createfiles'))
